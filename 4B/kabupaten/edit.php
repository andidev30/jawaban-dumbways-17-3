...
<?php 
        ...
        $provinsi = mysqli_query($con, $query);
        ...
        if(isset($_POST['tambah'])){
            ...
            if(isset($_POST['tambah'])){
                $nama = htmlspecialchars($_POST['nama']);
                $diresmikan = htmlspecialchars($_POST['diresmikan']);
                $provinsi_id = htmlspecialchars($_POST['provinsi']);
                                    ...
                                    <div class="card-body">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-8 col-md-9">
                                                    <input type="text" value="<?= $row['nama'] ?>"
                                                        class="form-control form-control-sm" name="nama" id="nama"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="Provinsi" class="col-4 col-md-3">Provinsi</label>
                                                <div class="col-8 col-md-9">
                                                    <div class="form-group">
                                                        <select id="Provinsi" class="form-control" name="provinsi">
                                                            <?php foreach($provinsi as $prov) { ?>
                                                            <option value="<?= $prov['id'] ?>"
                                                                <?php echo($prov['id'] == $row['provinsi_id'] ? "selected" : "") ?>>
                                                                <?= $prov['nama'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-8 col-md-9">
                                                    <input type="date" value="<?= $row['diresmikan'] ?>"
                                                        class="form-control form-control-sm" name="diresmikan"
                                                        id="diresmikan" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
